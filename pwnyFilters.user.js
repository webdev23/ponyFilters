...
var pwnyStyle0 = document.createElement("style");
pwnyStyle0.innerHTML += "body,html{overflow-X:hidden;background-color:white;background:white;color:#111111}\
.mw{background-color:white;background:white;color:#111111;margin:0;padding:0}"
document.getElementsByTagName("body")[0].children[0].insertBefore(pwnyStyle0,document.getElementsByTagName("script")[0].children[1])
document.getElementsByTagName("body")[0].appendChild(pwnyStyle0)
