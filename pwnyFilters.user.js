...
let bzr = document.body.getElementsByTagName("img");
for (i = 0; i < bzr.length;) {
	var wi = bzr[i].width; var he = bzr[i].height;
	bzr[i].setAttribute("ondrag", "window.open(this.src,'this.src','width="+wi+",height="+he+",resizable=1')"), i++;}
